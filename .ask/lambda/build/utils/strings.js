...
exports.strings = {
    [constants_1.LocaleTypes.enUS]: {
        translation: {
            WELCOME: "Welcome to Fearless!  Where we make software with a soul.  I can tell you many things to give you an idea about the company and what we do.  You can say <emphasis>culture</emphasis> to hear more about our cultural beliefs.  If you are lost, just say <emphasis>help</emphasis>. What would you like to do?",
            ...
            PRINCIPALS_INTRO: "At the foundation of Fearless culture are four principals.  First, create belonging.  Second, make an impact.  Third, encourage open dialog.  And fourth, take initiative.  Say first principal, second principal, third principal, or fourth principal to hear more about them.  Would you like to hear the first principal?",
            ...
            PRINCIPALS_SECOND: "The second principal is to make an impact.  We strive for building digital services that can change the world for the better.  We also believe that this work is done best when we feel our best.  We respect holidays and time off, and applaud those who have achieved effective work life balances.  Would you like to hear the third principal?",
    ...
    [constants_1.LocaleTypes.esES]: {
        translation: {
            WELCOME: "¡Bienvenidos a Fearless! Donde hacemos software con alma. Puedo contarte muchas cosas para darte una idea de la empresa y de lo que hacemos. Puede decir <emphasis>cultura</emphasis> para escuchar más sobre nuestras creencias culturales. Si estás perdido, solo di <emphasis>ayuda</emphasis>. Que te gustaría hacer?",
            EMPLOYEE_COUNT: "Fearless actualmente tiene {{count}} miembros del equipo.",
            PET_COUNT: "Hay {{count}} {{pet}} propietarios en Fearless.",
            PET_COUNT_UNKNOWN_PET: "No estoy seguro de cuántos {{pet}} propietarios hay en Fearless.",
